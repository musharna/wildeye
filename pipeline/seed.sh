...
set -euo pipefail
cd "$(dirname "$0")/.."
for f in birds aloft occurrences tracks wastewater otn hpai neon gfw whispers arbonet phenology neon-vectors cetaceans drought h5n1 fires ecoregions rivers; do
