...
| OTN detections (ERDDAP) | **parked** (species needs a 3-table join: view_otn_aat_detections_stations_projects × view_otn_aat_animal_tag_releases × otn_aat_animals; ERDDAP returned 504/timeouts on aggregate queries 2026-09-11) | CC-BY 4.0 | keep per-row citation; notify otndc@dal.ca | per-row citation + "Ocean Tracking Network, CC-BY 4.0" | erddap.oceantrack.org info; members.oceantrack.org/data/policies |
