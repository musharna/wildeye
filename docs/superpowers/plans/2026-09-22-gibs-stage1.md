...
- [ ] **Step 8: Cron + seed + ignore.**
  ...
  `30 6 * * * /home/mjarnold/wildeye/pipeline/run_gibs.sh >> /home/mjarnold/wildeye/pipeline/cron_gibs.log 2>&1` — the crontab line is machine config, not a repo file, so the absolute path is fine there.
