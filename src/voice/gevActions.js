...
const LAYER_ALIASES = aliasMap([
  ...
  ['migration', 'birds'],
  ['radar birds', 'birds'],
  ['european birds', 'aloft'],
  ['europe birds', 'aloft'],
  ['aloft', 'aloft'],
  ['coral bleaching', 'crw-bleaching'],
  ['bleaching', 'crw-bleaching'],
  ['coral', 'crw-bleaching'],
  ['degree heating weeks', 'crw-dhw'],
  ['heat stress', 'crw-dhw'],
  ['hotspot', 'crw-hotspot'],
  ['coral hotspot', 'crw-hotspot'],
  ['sea ice', 'crw-seaice'],
  ['ndvi', 'ndvi'],
  ['land cover', 'gibs-landcover'],
  ['habitat', 'gibs-landcover'],
  ['evi', 'gibs-evi'],
  ['land surface temperature', 'gibs-lst'],
  ['night lights', 'gibs-nightlights'],
  ['light pollution', 'gibs-nightlights'],
  ['biomass', 'gibs-biomass'],
  ['forest carbon', 'gibs-biomass'],
  ['animal tracks', 'tracks'],
  ['tracks', 'tracks'],
  ['seals', 'tracks'],
  ['telemetry', 'tracks'],
  ['wastewater', 'wastewater'],
  ['sewage', 'wastewater'],
  ['covid wastewater', 'wastewater'],
  ['virus trend', 'wastewater'],
  ['acoustic detections', 'otn'],
  ['bird flu', 'hpai'],
  ['small mammals', 'neon'],
  ['deforestation', 'gfw'],
  ...
  ['introduced species', 'griis'],
  ['griis', 'griis'],
  ['oxygen', 'cmems-o2'],
  ['die-offs', 'whispers'],
  ['die offs', 'whispers'],
  ['wildlife disease', 'whispers'],
  ['wildlife mortality', 'whispers'],
  ['whispers', 'whispers'],
  ['river temperature', 'rivers'],
  ['stream gages', 'rivers'],
  ['river flow', 'rivers'],
  ...
  ['biomes', 'ecoregions'],
  ['biome map', 'ecoregions'],
  ['habitat types', 'ecoregions'],
  ['nature needs half', 'ecoregions'],
  ['wildfires', 'fires'],
  ['wildfire cells', 'fires'],
  ['fire radiative power', 'fires'],
  ['viirs fires', 'fires'],
  ['fire map', 'fires'],
  ['h5n1', 'h5n1'],
  ['avian flu genomes', 'h5n1'],
  ['dairy cattle flu', 'h5n1'],
  ['nextstrain', 'h5n1'],
  ['flu sequences', 'h5n1'],
  ['drought', 'drought'],
  ...
  ['usdm', 'drought'],
  ['whale detections', 'cetaceans'],
  ['whales', 'cetaceans'],
  ['right whales', 'cetaceans'],
  ['passive acoustics', 'cetaceans'],
  ['whale calls', 'cetaceans'],
  ['ticks', 'neon-vectors'],
  ['mosquitoes', 'neon-vectors'],
  ['disease vectors', 'neon-vectors'],
  ['tick drags', 'neon-vectors'],
  ['phenology', 'phenology'],
  ['leaf out', 'phenology'],
  ['flowering', 'phenology'],
  ['blooms', 'phenology'],
  ...
  ['west nile', 'arbonet'],
  ['mosquito diseases', 'arbonet'],
  ['tick-borne disease', 'arbonet'],
  ['arbonet', 'arbonet'],
  ['dengue cases', 'arbonet'],
  ['dissolved oxygen', 'cmems-o2'],
  ['hypoxia', 'cmems-o2'],
  ['ocean ph', 'cmems-ph'],
